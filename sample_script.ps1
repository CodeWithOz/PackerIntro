# This is part of Packer's official intro tutorial on building and
# customizing images.
# See https://www.packer.io/intro/getting-started/build-image.html
# This file is for the Windows example of customizing an AMI.
